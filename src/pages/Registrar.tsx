...
import { ArrowLeft, DollarSign, FileText, Camera, Sparkles, Loader2, X, Check, AlertCircle, ImagePlus } from "lucide-react";
...
export default function Registrar() {
  ...
  const procesarOCR = async (file: File) => {
    ...
    try {
      ...
      if (datos.monto) setMonto(String(datos.monto));
